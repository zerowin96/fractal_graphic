...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/24 18:07:20 by yeham             #+#    #+#             */
/*   Updated: 2022/12/23 15:53:54 by yeham            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	makeship(void)
{
	...
	var.mlx = mlx_init();
	var.mlx_win = mlx_new_window(var.mlx, X_LEN, Y_LEN, "Burning Ship");
	...
	setting(&var);
	print_ship(&var);
	mlx_mouse_hook(var.mlx_win, ship_mouse_hook, &var);
	mlx_key_hook(var.mlx_win, ship_key_hook, &var);
